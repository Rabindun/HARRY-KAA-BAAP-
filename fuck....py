...
╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝░░░╚═╝\u001b[31mv4
\033[1;37m----------------------------------------------
 AUTHOR     : HARRY X NIKHIL
 GITHUB     : HARRYYY-XD
 FACEBOOK   : HARRY DON
 VERSION    :\u001b[36m 0.4.4\033[1;37m
\033[1;37m----------------------------------------------""")
...
def setting():
	...
	if hu in ['1','01']:
		...
		for xmud in range(bcm):
			id2.append(abbbcc[bcmi])
			bcmi -=1
	elif hu in ['3','03']:
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,abbbcc)
	else:
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,abbbcc)
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[HARRY-DW]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
